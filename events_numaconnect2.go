...
//         {0x000, "n2Cyc", "cycles", false},
         ...
         {0x010, "n2CycRmpe0freeS", "cycles the RMPE had free contexts for SIU accesses", false},
         {0x030, "n2CycRmpe0freeP", "cycles the RMPE had free contexts for PIU accesses", false},
         ...
         {0x0B8, "n2CycLmpeFreePiu", "cycles the LMPE had free contexts for SIU accesses", false},
         {0x0D8, "n2CycLmpeFreeSiu", "cycles the LMPE had free contexts for PIU accesses", false},
         ...
         {0x210, "n2VicBlkXRecv", "VicBlk and VicBlkClean commands received", false},
         {0x218, "n2RdBlkXRecv", "RdBlk and RdBlkS commands received", false},
         {0x220, "n2RdBlkModRecv", "RdBlkMod commands received", false},
         {0x228, "n2ChangeToDirtyRecv", "ChangeToDirty commands received", false},
         {0x230, "n2RdSizedRecv", "RdSized commands received", false},
         {0x238, "n2WrSizedRecv", "WrSized commands received", false},
         {0x240, "n2DirPrbRecv", "directed Probe commands received", false},
         {0x248, "n2BcastPrbRecv", "broadcast Probe commands received", false},
         {0x250, "n2BcastCmdRecv", "Broadcast commands received", false},
         {0x258, "n2RdRespCmdRecv", "RdResponse commands received", false},
         {0x260, "n2PrbRespCmdRecv", "ProbeResponse commands received", false},
         {0x268, "n2CachelinesRecv", "data packets with full cachelines of data received", false},
         {0x270, "n2PartCachelinesRecv", "data packets with less than a full cache line received", false},
         {0x278, "n2VicBlkXSent", "VicBlk and VicBlkClean commands sent", false},
         {0x280, "n2RdBlkXSent", "RdBlk and RdBlkS commands sent", false},
         {0x288, "n2RdBlkModSent", "RdBlkMod commands sent", false},
         {0x290, "n2ChangeToDirtySent", "ChangeToDirty commands sent", false},
         ...
         {0x2D0, "n2LessCachelinesSent", "data packets with less than a full cache line sent", false},
