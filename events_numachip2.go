...
func NewNumaconnect2() *Numaconnect2 {
   return &Numaconnect2{
      events: []Event{
         ...
         {0x428, "n2CacheTag2WriteWritebacks", "read accesses with writebacks to Ctag cache 2", false},
         {0x430, "n2CacheTag2WriteMiss", "write miss accesses to Ctag cache 2", false},
         {0x438, "n2CacheTag2WriteMiss", "read miss accesses to Ctag cache 2", false},
